...
use crate::system::{BoxedSystem, SystemConfig};
...
impl SystemRegistry {
    ...
    pub fn register(&mut self, system: BoxedSystem) {
        ...
        // Index by handled commands
        for cmd_kind in system.handles_commands() {
    ...
    /// Get a system by ID
    pub fn get(&self, system_id: &str) -> Option<&dyn crate::system::System> {
        self.by_id
            .get(system_id)
    ...
    pub fn enabled_systems(&self) -> impl Iterator<Item = &dyn crate::system::System> {
...
mod tests {
    ...
    use engine_primitives::{EntityId, Rng};
    ...
    fn dispatch_command() {
        ...
        let state = engine_world::WorldState::new();
